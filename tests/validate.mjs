...
if (fs.existsSync(indexPath)) {
  ...
  if (indexHtml.includes('88 דפי A4') || indexHtml.includes('38 דפי A4') || indexHtml.includes('46 דפי A4') || indexHtml.includes('172 דפי A4')) fail('index.html: canonical page counts must not be duplicated as hard-coded home text');
